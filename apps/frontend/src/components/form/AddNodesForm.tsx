import { fetchModelsNames, fetchModelSubsectionLayout, fetchNodesNames, fetchNodeSubsectionLayout, Layout, Subsection } from "@/lib/fetchers";
...
export default function AddNodesForm(
    { onSubmit }: AddNodesFormProps
) {
    const {
        data: nodesNames, error: nodesNamesError, isLoading: nodesNamesLoading,
    } = useSWR<string[]>('nodes_names', () => fetchNodesNames());
    const {
        data: mobilityModelsNames, error: mobilityModelsNamesError, isLoading: mobilityModelsNamesLoading,
    } = useSWR<string[]>('mobility_models_names', () => fetchModelsNames('mobility'));
    const {
        data: connectivityModelsNames, error: connectivityModelsNamesError, isLoading: connectivityModelsNamesLoading,
    } = useSWR<string[]>('connectivity_models_names', () => fetchModelsNames('connectivity'));
    const {
        data: interferenceModelsNames, error: interferenceModelsNamesError, isLoading: interferenceModelsNamesLoading,
    } = useSWR<string[]>('interference_models_names', () => fetchModelsNames('interference'));
    const {
        data: reliabilityModelsNames, error: reliabilityModelsNamesError, isLoading: reliabilityModelsNamesLoading,
    } = useSWR<string[]>('reliability_models_names', () => fetchModelsNames('reliability'));
    const {
        data: distributionModelsNames, error: distributionModelsNamesError, isLoading: distributionModelsNamesLoading,
    } = useSWR<string[]>('distribution_models_names', () => fetchModelsNames('distribution'));

    const [queryForm, setQueryForm] = useQueryState<Record<string, any>>('add_nodes_form', { parse: JSON.parse, serialize: JSON.stringify });
    ...
    const addNodesForm = useForm<AddNodesFormSchema>({
        resolver: addNodesFormSchema &&
            zodResolver(addNodesFormSchema as unknown as Parameters<typeof zodResolver<AddNodesFormSchema, any, AddNodesFormSchema>>[0])
    });
    const { handleSubmit, control, register, reset, watch, setValue, getValues, formState: { errors: formErrors } } = addNodesForm;

    const {
        data: { layout: nodeParametersSubsection, defaultParameters } = { layout: undefined, defaultParameters: undefined },
    ...
    } = useSWR(watch('mobility_model') && `mobility_model_parameters_subsection_${watch('mobility_model')}`,
    ...
    } = useSWR(watch('connectivity_model') && `connectivity_model_parameters_subsection_${watch('connectivity_model')}`,
    ...
    } = useSWR(watch('distribution_model') && `distribution_model_parameters_subsection_${watch('distribution_model')}`,
    ...
    } = useSWR(watch('reliability_model') && `reliability_model_parameters_subsection_${watch('reliability_model')}`,
    ...
    } = useSWR(watch('interference_model') && `interference_model_parameters_subsection_${watch('interference_model')}`,
            ...
            sections: [
                {
                    ...
                    subsections: [
                            ...
                            lines: [
                                {
                                    fields: [
                                        ...
                                        } as NumberField,
                                        {
                                            id: 'node-name',
                                            informative: {
                                                title: 'Use only the name if is a default implementation or project_name:node_implementation if is a custom implementation',
                                                help_text: 'Use only the name if is a default implementation or project_name:node_implementation if is a custom implementation',
                                                as_html: false,
                                            },
                                            label: 'Node',
                                            name: 'node',
                        ...
                        } as Subsection, nodeParametersSubsection] :
                            nodeParametersSubsection ? [nodeParametersSubsection] : []),
                    ]
                },
                {
                                    ...
                                    fields: [
                                        {
                                            ...
                                            informative: {
                                                ...
                                                as_html: true,
                                                help_text: "The name of the distribution model.<br/>Use the following format: \"project_name:model_name\" to import from the project's distribution models.<br/>Use the following format: \"model_name\" to import from the default distribution models."
                                            },
                                        } as ModelSelectField
                                    ]
                                }
                                    ...
                                    fields: [
                                        {
                                            ...
                                            informative: {
                                                ...
                                                help_text: "The name of the mobility model.<br/>Use the following format: \"project_name:model_name\" to import from the project's mobility models.<br/>Use the following format: \"model_name\" to import from the default mobility models.",
                                                as_html: true
                                            }
                                        } as ModelSelectField
                                    ]
                                    ...
                                    fields: [
                                        {
                                            ...
                                            informative: {
                                                ...
                                                help_text: "The name of the connectivity model.<br/>Use the following format: \"project_name:model_name\" to import from the project's connectivity models.<br/>Use the following format: \"model_name\" to import from the default connectivity models.",
                                                as_html: true
                                            }
                                        } as ModelSelectField
                                    ]
                                    ...
                                    fields: [
                                        {
                                            ...
                                            informative: {
                                                ...
                                                help_text: "The name of the interference model.<br/>Use the following format: \"project_name:model_name\" to import from the project's interference models.<br/>Use the following format: \"model_name\" to import from the default interference models.",
                                                as_html: true
                                            },
                                        } as ModelSelectField
                                    ]
                                    ...
                                    fields: [
                                        {
                                            ...
                                            informative: {
                                                ...
                                                as_html: true,
                                                help_text: "The name of the reliability model.<br/>Use the following format: \"project_name:model_name\" to import from the project's reliability models.<br/>Use the following format: \"model_name\" to import from the default reliability models."
                                            },
                                        } as ModelSelectField
                                    ]
                                }
    ...
    useEffect(() => {
        if (mobilityModelParametersSubsectionError ||
            ...
            console.error(mobilityModelParametersSubsectionError ||
                connectivityModelParametersSubsectionError ||
                interferenceModelParametersSubsectionError ||
                reliabilityModelParametersSubsectionError ||
                distributionModelParametersSubsectionError);
    ...
    useEffect(() => {
        if (mobilityModelsNamesError || connectivityModelsNamesError || interferenceModelsNamesError || reliabilityModelsNamesError || distributionModelsNamesError) {
            console.error(mobilityModelsNamesError || connectivityModelsNamesError || interferenceModelsNamesError || reliabilityModelsNamesError || distributionModelsNamesError);
            toastError('Error loading models names');
        }
    }, [mobilityModelsNamesError, connectivityModelsNamesError, interferenceModelsNamesError, reliabilityModelsNamesError, distributionModelsNamesError]);

    if (nodesNamesLoading ||
        ...
        return <div className="w-full h-full flex items-center justify-center text-3xl">
            Loading form...
        </div>;
    }
